...
const SocialMediaBar = () => {
  ...
  const socialLinks = [
    ...
    {
      name: 'WhatsApp',
      url: 'https://wa.me/201234567890', // Replace with your WhatsApp number (country code + number, no +)
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      name: 'TikTok',
      url: 'https://tiktok.com/@yourprofile', // Replace with your TikTok
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      name: 'Facebook',
      url: 'https://facebook.com/yourprofile', // Replace with your Facebook
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
